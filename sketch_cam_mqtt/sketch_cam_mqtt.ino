...
// ==== Cấu hình Wi-Fi ====
const char* ssid     = "Redmi K50";         // Thay bằng Wi-Fi Raspberry Pi đang dùng
...
// ==== Hàm publish MQTT reconnect ====
void reconnect() {
  while (!client.connected()) {
    Serial.print("Kết nối MQTT...");
    if (client.connect("ESP32CAM")) {
      Serial.println("✓ MQTT connected!");
      client.publish("esp32cam/status", "Camera online!");
    } else {
